...
KEYBINDS_CONF="$HOME/.config/hypr/default/keys.conf"
USER_KEYBINDS_CONF="$HOME/.config/hypr/local/keys.conf"
...
echo "$KEYBINDS" | rofi -dmenu -i -p "Keybinds" -config ~/.config/hypr/rofi/config-keybinds.rasi
